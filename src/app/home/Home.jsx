...
const Home = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.totalFamily) newErrors.totalFamily = 'Total family members is required';
    ...
    if (formData.totalFamily && formData.totalFamily < 1) {
      newErrors.totalFamily = 'Family members must be at least 1';
    }
          ...
          <div className="bg-white rounded-[0.4rem] shadow-2xl overflow-hidden">
            <div className="px-8 py-4">
              <div className="text-center mb-4">
                <h2 className="text-2xl font-bold text-transparent bg-orange-700 bg-clip-text mb-1">Bangalore Vaishnav Form</h2>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                    />
                    {errors.totalFamily && <span className="text-xs text-red-500">{errors.totalFamily}</span>}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-amber-800 mb-2">Telephone</label>
                    <input
                      type="tel"
                      name="telephone"
                      ...
                      onChange={handleInputChange}
                      onKeyDown={keyDown}
                      className="w-full px-4 py-3 border border-gray-400/80 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-amber-800 mb-2">Website</label>
                    <input
                      type="url"
                      name="website"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-amber-800 mb-2">Fax</label>
                    <input
                      type="text"
                      name="fax"
                      value={formData.fax}
                ...
                <div>
                  <label className="block text-sm font-medium text-amber-800 mb-2">Other Details</label>
                  <textarea
                    name="other"
